...
public abstract class Contrato implements CalculaMulta{
	...
	public Contrato( Cliente cliente, Gerente gerente, Calendar dataFim, BigDecimal valor, List <Parcela> parcelas){
